...
class DetailActivity : BaseActivity() {
    ...
    private fun DetailScreen(
        ...
        var selectecModelIndex by remember { mutableStateOf(-1) }
        ...
        )
        {
            ...
            ModelSelector(
                models = item.model,
                selectecModelIndex = selectecModelIndex,
                onModelSelected = { selectecModelIndex = it }
            )
            ...
            itemsIndexed(models) { index, model ->
                Box(
                    modifier = Modifier
                        ...
                        .background(
                            if (index == selectecModelIndex) colorResource(R.color.darkBrown)
                    ...
                    Text(
                        ...
                        fontSize = 18.sp,
                        color = if (index == selectecModelIndex) colorResource(R.color.white)
    ...
    fun ImageThumbnail(imageUrl: String, isSelected: Boolean, onClick: () -> Unit) {
        ...
        Box(
            modifier = Modifier
                ...
                .background(
                    backColor, shape = RoundedCornerShape(10.dp)
                )
